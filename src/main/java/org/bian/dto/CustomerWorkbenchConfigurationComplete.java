...
/**
 * To access/update the customer workbench configuration
 */
public class CustomerWorkbenchConfigurationComplete   {
  private String customerWorkbenchOperatingSessionReference = null;

  private String customerWorkbenchConfigurationRecordReference = null;
  ...
  **/
  ...
  /**
   * general-info: used to access/update the configuration `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier 
   * @return customerWorkbenchConfigurationRecordReference
  **/

  public String getCustomerWorkbenchConfigurationRecordReference() {
    return customerWorkbenchConfigurationRecordReference;
  }

  public void setCustomerWorkbenchConfigurationRecordReference(String customerWorkbenchConfigurationRecordReference) {
    this.customerWorkbenchConfigurationRecordReference = customerWorkbenchConfigurationRecordReference;
  }
  ...
  **/
  ...
  /**
   * `status: Provisionally Registered` bian-reference:  (asSession).UserDevice(asResource).ResourceIdentification 
